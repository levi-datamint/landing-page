...
export const speakers: Speaker[] = [
  ...
  },
  {
    name: "תום פניני",
    title: "רו״ח",
    bio: "מומחה ל-AI ואוטומציה במחלקות פיננסים. משמש כ-Fractional CFO ומלווה חברות בהטמעת טכנולוגיות AI, ייעול תהליכים פיננסיים ושילוב חכם בין כספים, נתונים וחדשנות.",
    imageUrl: "/tom_pnini.png",
  },
  {
    name: "לינור ",
    title: "רו״ח ו - CFO",
    bio: "מלווה סטארטאפים בעולמות הפיננסים. במקום לחכות שמישהו יבנה את הכלים שהיא צריכה, היא בונה אותם בעצמה עם Claude Code בלי רקע בתכנות. בהרצאה היא תראה איך כל איש כספים יכול להפוך משעות של עבודה ידנית לכלי חכם שעובד בשבילו.",
    imageUrl: "/linor.png",
  },
];
